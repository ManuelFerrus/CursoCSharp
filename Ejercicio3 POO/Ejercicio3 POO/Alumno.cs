...
namespace Ejercicio3_POO
{
    public class Alumno
    {
        ...
        {
            return nombrreAlumno;
        }

        public void setNombreAlumno(string nombreAlumno)
        {
            this.nombrreAlumno = nombreAlumno;
        }
        ...
        {
            return (this.nota1 + this.nota2) / 2.0;//Se divide /2.0, para que retorne decimal
        }
